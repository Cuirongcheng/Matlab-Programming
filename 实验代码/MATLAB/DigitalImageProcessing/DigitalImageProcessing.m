...
% DIGITALIMAGEPROCESSING MATLAB code for DigitalImageProcessing.fig
...
%
%      DIGITALIMAGEPROCESSING('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in DIGITALIMAGEPROCESSING.M with the given input arguments.
%
%      DIGITALIMAGEPROCESSING('Property','Value',...) creates a new DIGITALIMAGEPROCESSING or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before DigitalImageProcessing_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property informationhiding
%      stop.  All inputs are passed to DigitalImageProcessing_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to imagerecognition DigitalImageProcessing

% Last Modified by GUIDE v2.5 28-Nov-2019 09:12:19
...
% varargin   command line arguments to DigitalImageProcessing (see VARARGIN)
